    ...
    <aside className={cx('wrapper')}>
      ...
      <div className={cx('DivUserContainer')}>
        ...
        <div className={cx('userLinkContainer')}>
          <a className={cx('user-avatar')} href="/">
            <div
              className={cx('DivContainer-StyleUserAvatar')}
              style={{ width: '32px', height: '32px' }}
            >
              <span
                className={cx('SpanAvatarContainer-StyleAvatar')}
                style={{ width: '32px', height: '32px' }}
              >
                <img
                  alt=""
          ...
          <a className={cx('StyledTmpLink')} href="/tag">
            <div className={cx('DivDiscoverItemContainer')}>
              ...
              <p className={cx('PText')}>
                Không Sao Mà Em Đây Rồi | Thùy Chi | Thong Dong Mà Hát
              </p>
            </div>
          </a>
      ...
      <div className={cx('DivFooterContainer')}>
        <div className={cx('DivLinkContainer')}>
          <a className={cx('StyledNavLink')} href="/about">
            About
          </a>
          <a className={cx('StyledNavLink')} href="/browse">
            Tiktok Browse
          </a>
          <a className={cx('StyledNavLink')} href="/newsroom">
            Newsroom
          </a>
          <a className={cx('StyledNavLink')} href="/contact">
            Contact
          </a>
          <a className={cx('StyledNavLink')} href="/careers">
            Careers
          </a>
          <a className={cx('StyledNavLink')} href="/bytedance">
            ByteDance
          </a>
        </div>

        <div className={cx('DivLinkContainer')}>
          <a className={cx('StyledNavLink')} href="/forgood">
            Tiktok for Good
          </a>
          <a className={cx('StyledNavLink')} href="/advertise">
            Advertise
          </a>
          <a className={cx('StyledNavLink')} href="/developers">
            Developers
          </a>
          <a className={cx('StyledNavLink')} href="/transparency">
            Transparency
          </a>
          <a className={cx('StyledNavLink')} href="/tiktokrewards">
            Tiktok Rewards
          </a>
        </div>

        <div className={cx('DivLinkContainer')}>
          <a className={cx('StyledNavLink')} href="/help">
            Help
          </a>
          <a className={cx('StyledNavLink')} href="/safety">
            Safety
          </a>
          <a className={cx('StyledNavLink')} href="/terms">
            Terms
          </a>
          <a className={cx('StyledNavLink')} href="/privacy">
            Privacy
          </a>
          <a className={cx('StyledNavLink')} href="/creator-portal">
            Creator Portal
          </a>
          <a className={cx('StyledNavLink')} href="/community-guidelines">
            Community Guidlines
          </a>
        </div>
